...
export default async function Page({ params }: {
  ...
  const words = CorpusController.getRandomStrings(Corpus.MonkeyType1k, 50, "default")!
  return (
    <Stack>
      <TypingTest 
      ...
      />
      <Typography>
        by <Link href={`/author/${boardLayouts[0].meta[0].authorId}`}>{boardLayouts[0].meta[0].author}</Link>
      </Typography>
