...
import { CminiBoardType, CminiFinger, CminiKey } from "../cmini/types";
...
export default function Keyboard({ config, keys, heatmap, theme = defaultTheme, type = CminiBoardType.Staggered }: { keys: CminiKey[], heatmap: { [key: string]: number }; theme?: KeyboardTheme; type?: CminiBoardType; config: KeyboardConfig }) {
    ...
    const shouldStagger = type === CminiBoardType.Staggered
